    ...
    <?php wp_link_pages( array( 'before' => '<div class="page-link">' . 'Pages:', 'after' => '</div>' ) ); ?>
      ...
      <div class="inner">
        ...
        <div class="btnWrap">
          ...
          <a href="tel:0120-697-182" onclick="ga('send', 'event', '電話リンク', 'タップ', '一覧ボタン');" title="電話で無料相談" class="btnLightGreen">電話で無料相談</a>
          <a href="/contact-form/" title="フォームで相談" class="btnBlue">フォームで無料相談</a>
        </div>
      </div>
